package cn.six.espresso.failhandler;
...
/**
 * Displays a list with all available activities in this app.
 */
public class CustomFailHandlerActivity extends ListActivity {
    private static final String TAG = CustomFailHandlerActivity.class.getSimpleName();
